...
namespace THITN
{
    public partial class frmMain : DevExpress.XtraBars.Ribbon.RibbonForm
    {
        ...
        public void HienThiMenu ()
        {
            ...
            btTaoTaiKhoan.Enabled = btRegisteredList.Enabled = ribBaoCao.Visible = ribDanhMuc.Visible = ribNghiepVu.Visible = btScoreBoard.Enabled = btResultTest.Enabled = true;
